...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    remotePatterns: [
      ...
      {
        protocol: 'https',
        hostname: 'brsohcswljcotifzmcmw.supabase.co',
      },
      {
        protocol: 'https',
        hostname: '**',
  ...
  experimental: {
    optimizePackageImports: ['gsap', 'framer-motion', '@dnd-kit/core', '@dnd-kit/sortable', 'three', '@react-three/fiber', '@react-three/drei'],
  },

  // Configure Turbopack for Three.js (Next.js 16+)
  turbopack: {},

  // Configure webpack for Three.js (fallback for webpack mode)
  webpack: (config) => {
