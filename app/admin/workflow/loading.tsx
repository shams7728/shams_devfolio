/**
 * Loading state for workflow stages admin page
 */
...
export default function Loading() {
  return (
    <div className="space-y-6 pb-20 lg:pb-8">
      ...
      {/* Info Box Skeleton */}
      <div className="backdrop-blur-xl bg-white/70 dark:bg-zinc-900/70 rounded-xl border border-zinc-200/50 dark:border-zinc-700/50 p-4">
